"""Command-line interface for tracelines.

tracelines extract --area bucharest-city --sources google,mapillary,kartaview --out out.geojson
tracelines probe   --area bucharest-city --sources google,mapillary
...
def cmd_nearest(a) -> int:
    from .nearest import build_streetview_url, find_nearest_coverage
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="tracelines", description=__doc__, formatter_class=argparse.RawDescriptionHelpFormatter
    )
