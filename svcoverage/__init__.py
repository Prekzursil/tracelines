"""svcoverage — extract continuous street-level coverage polylines (the "blue lines").
...
See the docs for the filter contract and verification: https://prekzursil.github.io/svcoverage/docs/
"""
